...
The largest difference is that a higher percentage of graduates from EDR 5 and 7W that did not graduate from a post-secondary institution.
...
The ANOVA table indicates a relationship between the average number of years between high school graduation and earning first credential by EDR.

The primary trend is that the average number of years between high school graduation and earning first credential increases as a high school becomes more urban - 3.26 years for EDR 5 students, 3.58 for EDR 7E and 3.73 years for EDR 7W graduates.
...
First, let's look at it from a total dataset. Of the over 90,000 individuals that attended post-secondary in the dataset, over 42% graduated from a public, 4-year college, 28% graduated from a 2-year public college, 17% graduated from a private 4-year, and 9% graduated from a mixture of institution types.
...
1.  EDR 5:
    1.  Significantly more likely to earn a credential from a 2-year public university
    2.  Significantly less likely to earn a credential from a 4-year, public
2.  EDR 7E:
    1.  Significantly more likely to earn a credential from a private, non-profit 4-year college.
3.  EDR 7W:
    1.  Significantly more likely to earn a credential from a public, 4-year college
