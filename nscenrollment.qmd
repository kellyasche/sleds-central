...
So there are fewer observations in this dataset than previous subsets. Why? This is due to dropping a PersonID that wasn't in the Central graduate dataset. I did not do that for the previous subsets. However, those previous subsets will be filtered down once we join it with the master dataset.
...
Up next we will create a dataset indicating whether a PersonID that graduated from a Central MN high school attended a post-secondary institution in their high school's EDR.
...
The biggest difference is that EDR 7W performs like an urban district - attends 4-year public institution at a much higher rate while attending a 2-year public at a much lower rate. EDR 5 and 7E were the opposite.
...
The largest difference is that EDR 7W has a significantly higher percentage of students (21%) that also attend college in EDR 7W. In addition, a significantly higher percentage, 92%, of EDR 7E graduates attend college outside of their EDR.
...
Similar to the RUCA background, the more rural an EDR is, the higher the percentage of graduates attend college in Minnesota. EDR 5 had 73% of their graduates attend college in Minnesota while 70% of EDR 7W attended in Minnesota.
