...
ggplot(regions) +
  ...
  geom_sf(data = filter(regions, project.pr != "Central"), color = "grey85", aes(geometry = geometry, fill = project.pr)) +
  scale_fill_manual(values = c("#009933", "#009933", "#009933", "#009933", "#009933"))+
  theme_sf+
  labs(title= "Central project regions",
       subtitle = "Central is EDR 5, 7E, and 7W") +
  theme(legend.position = "bottom",
        text = element_text(size = 16))

ggsave(filename = "Charts/EPIC/not-central-project-region-map.pdf", device = cairo_pdf, dpi = "print", width = 8.5, height = 6.5)
