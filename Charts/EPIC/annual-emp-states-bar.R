...
ggplot(data = filter(data, emp.states != "Not meaningful, not attending ps"), aes(grad.year, pct, fill = emp.states)) +
...
ggsave(filename = "Charts/EPIC/annual-emp-states-bar.pdf", device = cairo_pdf, dpi = "print", width = 12, height = 6.5)
