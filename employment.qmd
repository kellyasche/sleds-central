...
Now I'm going to prep the employment data in order to join with the master dataset. So, let's import the original data. I will then filter so that I only have PersonID that have graduated from a high school in Central. The "Employment-Central.csv" file came from a script within that "Employment" folder, where I imported the very large employment dataset and then filtered the PersonID by Central MN grads.
...
-   PersonID: Every individual that graduated from a Central MN high school and was found within the large employment spreadsheet.
...
grad.locations <- read_csv("Data/SLEDS/Masters/Master-10.csv") %>%
  mutate(planning.region = "Central") %>%
...
grad.emp.location.match <- grad.locations %>%
  ...
  mutate(county.match = ifelse(employment.county == hs.county.name, 1,
         ...
         region.match = ifelse(emp.pr %in% c("Central"), 1,
                               ifelse(emp.edr == "Unknown", 0, -1)),
         state.match = 1) %>% 
...
It shows that 81% of the individuals had a MN employment record at their graduation year. That percentage drops to 69% two years after graduation and only 41% had a MN employment record 7 years after graduation. The percentage of people with no MN employment record hovers between 15% and 20%.
...
The cross tabs indicate a relationship between RUCA category and percentage of individuals that have a MN employment record for each graduation year timeframe. However, after reviewing the percentages I'm not seeing any important differences.
...
The cross tabs indicate a relationship between EDR and percentage of individuals that have a MN employment record for each graduation year time frame. However, after reviewing the percentages I'm not seeing any important differences.
...
The table below shows that the percentage of individuals working meaningful employment grows significantly as the years after graduation progress. By 7 years after graduating, 63% have meaningful employment. The percentage of individuals with no MN employment record grows as well - it's 26% of all individuals by seven years after graduating.
...
The cross tabs indicate a relationship, but after reviewing the percentages, I'm not seeing anything that is importantly different.
...
The cross tabs indicate a relationship. The biggest difference is that EDR 5 has a significantly lower percentage of graduates that have meaningful employment 7 years after graduation - 60% compared to 64% for EDR 7W.
...
The table below shows that 13% of the individuals in the master dataset had meaningful employment in the same county as their high school the year they graduated. It increased to 17% two years after graduation and then 18% seven years after graduation. These percentages are after filtering out all of the "After 2023" category.
...
-   hs.grad.year: The more rural a district is, the higher the percentage of graduates that have meaningful employment in the high school county - 14.1% for town/rural mix vs. 8.9% for entirely urban.

-   hs.grad.year.2: The increasing percentage for rural districts continues - 18.8% for town/rural mix districts vs. 11.3% for entirely urban.

-   hs.grad.year.7: Same as previous years - 19.5% for town/rural mix vs. 10.3% for entirely urban.
...
Crosstabs indicate a relationship. The biggest differnce is that EDR 7E has a significantly lower percentage of graduates that have meaninful employment in their county each year after graduating high school. By 7 years after graduating, only 11.6% have meaningful employment in their county compared to 20% in EDR 5, and 19% in EDR 7W.
...
The chart below shows that 15.5% of individuals in the main dataset had meaningful employment in the edr the year of graduation. The percent increases to 25.3% of individuals seven years after graduating. All "After 2023" individuals were taken out.
...
Interestingly, it shows that the more rural districts have a higher percentage of graduates that have meaningful employment in their EDR. By seven years after graduating, 17% of town/rural mix graduates had meaningful employment, compared to 16% for urban/town/rural mix, and 12.3% for entirely urban.
...
The chart below shows that 16.7% of individuals in the main dataset had meaningful employment in the region the year of graduation. The percent increases to 29.9% of individuals seven years after graduating. All "After 2023" individuals were taken out.
...
The chart has the exact same pattern as the percentage of students that work in the high school county by RUCA category - more rural districts have a higher percentage of individuals that have meaningful employment in the region.
...
The chart shows that EDR 5 has a significantly higher percentage of graduates that have meaningful employment in the region compared to the other EDRs. By seven years after graduating high school, 35.2% of the graduates from EDR 5 had meaningful employment in Central Minnesota compared to 24.5% for EDR 7E and 30% from EDR 7W.
