...
Next up is to join the ACT data. I'll first load the entire ACT dataset, clean it up, and then join with my master/Central graduate dataset to finalize.
...
The cross-tabs for the percentage of students who have taken the ACT by RUCA category has a p-value of less than .01, indicating that RUCA category is related. The trend shows a similar pattern as the RUCA categories. EDR 5 is the most rural and has the lowest percentage of graduates that took the ACT - 55% compared to EDR 7W with 66.5%.
...
Finally, here's a look at the percentages by county. The percentages are higher as the counties approach the seven county metro and thus are the most "urban". The lowest percentages are in the rural parts of the region - Northwest counties.
